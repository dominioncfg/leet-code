...
{
    private readonly IMinCostToConnectAllPoints sut;
    public MinCostToConnectAllPointsTests()
    {
        sut = new MinCostToConnectAllPoints();
    }

    [Fact]
    public void Test1()
    {
        var result = sut.MinCostConnectPoints([[0, 0], [2, 2], [3, 10], [5, 2], [7, 0]]);
        result.Should().Be(20);
    }
    ...
    public void Test2()
    {
        var result = sut.MinCostConnectPoints([[3, 12], [-2, 5], [-4, 1]]);
        result.Should().Be(18);
    }
